...
user in an INI file next to KeePassPortable.exe called KeePassPortable.ini.
...
copy AppNamePortable.ini from this directory to KeePassPortable.ini next to
KeePassPortable.exe. The options in the INI file are as follows:
